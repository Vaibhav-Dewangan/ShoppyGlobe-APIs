...
function WelcomePage(){
    return(
        <div className="Welcome-page bg-slate-100 w-screen mt-5  h-52 sm:h-56 md:h-60 lg:h-72  flex items-center  bg-center bg-cover bg-no-repeat bg-[url(/src/assets/welcome1.webp)]" >
